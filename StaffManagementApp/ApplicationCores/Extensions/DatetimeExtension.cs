...
namespace StaffManagementApp.ApplicationCores.Extensions
{
    ...
    {
        public static DateTime Add7Hours(this DateTime dateTime)
        {
            return dateTime.AddHours(7);
        }

        public static string GetCurrentDayState(this DateTime dateTime)
        {
    ...
    => dt == null ? "" : ((DateTime)dt).ToString(format);
        ...
        public static string DayCountElapsedFromNow(this DateTime dt)
        {
            DateTime now = DateTime.Now;

            TimeSpan elapsed = now.Subtract(dt);
            return string.Format("{0} day{1} ago", (int)elapsed.TotalDays, (elapsed.TotalDays >= 1) ? "s" : "");
        }

        public static DateTime MaxDateTime(this DateTime dt)
        {
            return new DateTime(dt.Year, dt.Month, dt.Day, 23, 59, 59);
        }

        public static DateTime MinDateTime(this DateTime dt)
        {
            return new DateTime(dt.Year, dt.Month, dt.Day, 0, 0, 0);
        }

        public static DateTime MinMonth(this DateTime dt)
        {
            return new DateTime(dt.Year, dt.Month, 1, 0, 0, 0);
        }

        public static DateTime MaxMonth(this DateTime dt)
        {
        ...
        public static DateTime MondayInWeek(this DateTime dt)
        {
            ...
            return dt.AddDays(-daysTillCurrentDay);
        }

        public static string GetTodayDateTimeRange(this DateTime dt)
        {
            return DateTime.Now.ToString("dd/MM/yyyy") + "-" + DateTime.Now.ToString("dd/MM/yyyy");
        }

        public static string ToStringNullable(this DateTime dt, string format)
        {
            if (dt.Year != new DateTime(1900, 1, 1).Year && dt.Year != 1)
            {
        ...
        {
            if ((dt - new DateTime(1, 1, 1, 0, 0, 0)).TotalMinutes == 0)
            {
                return true;
            }
            return false;
        ...
        public static DateTime GetNullDate(this DateTime dt)
        {
